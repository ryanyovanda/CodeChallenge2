    ...
    return(
        ...
        <div className="flex flex-row justify-between xs:flex-col md:flex-row gap-6">
            ...
            <div className="flex gap-2 flex-row">
                <Link className=" bg-transparent border-[1px] border-white rounded-3xl h-auto w-auto px-6 py-1 flex items-center justify-center hover:bg-white hover:border-white hover:text-[#232323]" href="https://www.instagram.com/ryovanda" target="_blank">Instagram</Link>
                <Link className=" bg-transparent border-[1px] border-white rounded-3xl h-auto w-auto px-6 py-1 flex items-center justify-center hover:bg-white hover:border-white hover:text-[#232323]" href="https://www.linkedin.com/in/ryanyovanda/" target="_blank">Linkedin</Link>
            </div>
        </div>
        </div>
